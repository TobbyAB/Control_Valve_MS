...
/*	SpiWriteAutoAddressRegister(REG_AX5043_MODCFGF              , 0x00);
	...
	SpiWriteAutoAddressRegister(REG_AX5043_MODCFGA              , 0x05); //05是差分模式，06是单路模式
	SpiWriteAutoAddressRegister(REG_AX5043_TXRATE2              , 0x00);
	...
	SpiWriteAutoAddressRegister(REG_AX5043_TXPWRCOEFFB1         , 0x05);//13dbm 0C    12dbm 09   10dbm  07   0dbm  02
	SpiWriteAutoAddressRegister(REG_AX5043_TXPWRCOEFFB0         , 0xBC);//      00          D4          00         07
